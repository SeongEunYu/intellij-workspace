...
function  findJournal(e) {
	...
	//dhxWins.setImagePath("${dhtmlXImagePath}");
	...
	//w1 = wins.createWindow('w1', pageX, pageY, 600, 480);
}
...
function findInst(rowID){
	...
	winGrid.attachEvent('onRowSelect', insteute_onRowSelect);
	winGrid.init();
	winGrid.loadXML('${contextPath}/code/findOrgCodeList.do?keyword=' + encodeURIComponent(winToolbar.getValue('keyword')));

}
function insteute_onRowSelect(id){
