...
<script type="text/javascript" src="${contextPath}/js/output/degree.js"></script>
<script type="text/javascript">
</script>
</head>
<body style="overflow-y: auto;">
	<form name="popFrm" id="popFrm" method="post">
		<input type="hidden" name="degree_id" id="popDegreeId"/>
	</form>
	<div class="popup_wrap">
		...
		<div class="top_help_wrap">
			<div class="help_text" style="display: none;">
				<spring:message code="comment.degr"/>
			</div>
			<p class="help_bt_box">
		...
		<div class="top_mn_box">
			...
			<div class="mn_text">
				<spring:message code='common.mng.no'/><strong>${degreeId}</strong>
			</div>
...
if(degreeId)
{
	$.post("${contextPath}/${preUrl}/degree/modifyForm.do", {"degreeId": degreeId},null,'text').done(function(data){$('#formObj').html(data);});
}
else
{
	$.post("${contextPath}/${preUrl}/degree/addForm.do", null,null,'text').done(function(data){$('#formObj').html(data);});
}
...
function loadAddFormData(){
	$.post("${contextPath}/${preUrl}/degree/addForm.do", null,null,'text').done(function(data){$('#newBtn').remove(); $('#delBtn').remove(); $('.top_mn_box').remove(); $('#formObj').html(data); isChange = false;});
}
...
function fn_delete(){
	dhtmlx.confirm({
		...
		callback:function(result){
			if(result){
				$.ajax({
					url:'${contextPath}/degree/removeDegree.do',
