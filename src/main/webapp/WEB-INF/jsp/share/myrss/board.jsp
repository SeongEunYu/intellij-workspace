...
<head>
    <script type="text/javascript">
        ...
        function goDocument(page){
            ...
            $(location).attr('href',"${pageContext.request.contextPath}/personal/myRss/rBoard.do?"+addr);
        }
                        ...
                        <c:choose>
                            <c:when test="${fn:length(boardList) > 0}">
                                <c:forEach items="${boardList}" var="board">
                                    <tr>
                                        <td class='al_left'><a href="${pageContext.request.contextPath}/personal/myRss/rBoardDetail.do?bbsId=${board.bbsId}&page=${page}&order=${order}&sort=${sort}">${board.title}</a></td>
