...
<script type="text/javascript">
	var swfu, upload_url = "${contextPath}/import/uploadFile.do?gubun=<%=R2Constant.SOURC_TYPE_JCR%>";
	...
	$(document).ready(function(){
		...
		myForm.attachEvent("onChange", function(name,value,is_checked){
			myVault.setURL("${contextPath}/import/vaultUploadFile.do?gubun=<%=R2Constant.SOURC_TYPE_JCR%>&format="+value);
			myVault.setSLURL("${contextPath}/import/vaultUploadFile.do?gubun=<%=R2Constant.SOURC_TYPE_JCR%>&format="+value);
			myVault.setSWFURL("${contextPath}/import/vaultUploadFile.do?gubun=<%=R2Constant.SOURC_TYPE_JCR%>&format="+value);
		});
	...
	function getGridRequestURL(){ return "${contextPath}/import/findRdHisotryList.do?gubun=<%=R2Constant.SOURC_TYPE_JCR%>"; }
...
<form id="sForm" name="sForm" method="post" action="${contextPath}/import/parseJcr.do?utilType=exr">
	<input type="hidden" name="pMenuId" value="${param.pMenuId}"/>
	<!-- Page Title -->
	<div class="title_box">
		<h3><spring:message code="menu.jcr.import"/></h3>
	</div>
	<!-- Main Content -->
