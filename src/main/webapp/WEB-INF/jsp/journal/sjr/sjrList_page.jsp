...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("iframe").prop("src", "${sysConf['s2journal.page.url']}/rank/sjr/list.do?key=${sysConf['s2journal.api.key']}&frameWidth=&frameHeight=");
    });
</script>
</head>
<body style="overflow-y: hidden;">
	<!-- Page Title -->
	<div class="title_box">
		<h3><spring:message code='menu.sjr.list'/></h3>
	</div>
	<!-- Main Content -->
