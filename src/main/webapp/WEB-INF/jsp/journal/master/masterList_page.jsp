...
<title>SJR List </title>
<%@include file="../../pageInit.jsp" %>
<script type="text/javascript" src="${contextPath}/js/mainLayout.js"></script>
<script type="text/javascript">
    $(document).ready(function(){
        setMainLayoutHeight($('#mainLayout'),-50);
        $("iframe").prop("src", "${sysConf['s2journal.page.url']}/master/list.do?key=${sysConf['s2journal.api.key']}&frameWidth=&frameHeight=");
    });
</script>
</head>
<body style="overflow-y: hidden;">
	<!-- Page Title -->
	<div class="title_box">
		<h3><spring:message code='menu.master.list'/></h3>
	</div>
	<!-- Main Content -->
