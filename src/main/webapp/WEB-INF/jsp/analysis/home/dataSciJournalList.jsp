...
<jsp:scriptlet>
    ...
    pageContext.setAttribute("crlf", "\r\n");
		...
		<form id="frm" name="frm" action="${contextPath}/home/dataSciJournalList.do" method="post">
		<input type="hidden" name="bbsType" id="bbsType" value="${bbsType}"/>
			<!--START page_title-->
	<h3>Monthly SCI Journal 'Add or Drop' List</h3>
			<!--END page_title-->
		...
		<div class="help_text mgb_30"><spring:message code="asrms.aboutsci.sci_journal_list.desc"/></div>
			...
			<div class="sub_content_wrapper">
				<table width="100%" id="publicationsTbl" class="list_tbl mgb_20">
					   <colgroup>
						...
						<tbody>
							<c:if test="${fn:length(sciList) > 0}">
								<c:forEach items="${sciList}" var="item" varStatus="status">
