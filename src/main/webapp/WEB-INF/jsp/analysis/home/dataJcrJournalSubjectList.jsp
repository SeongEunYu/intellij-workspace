...
<jsp:scriptlet>
    ...
    pageContext.setAttribute("crlf", "\r\n");
		...
		<form id="frm" name="frm" action="${contextPath}/analysis/institution/byHindex.do" method="post">
		...
		<input type="hidden" name="clgCd" id="clgCd" value="<c:out value="${clgCd}"/>"/>
			<!--START page_title-->
	<h3>Journal Impact Factor List by year</h3>
			<!--END page_title-->
			...
			<div class="help_text mgb_30"><spring:message code="asrms.aboutsci.jcr_journal_list.desc"/></div>
				...
				<table width="100%" class="detail_table">
					<colgroup>
						...
						<tr>
							...
							<td colspan="3"><span style="font-size: 9pt;color: #474747;" id="bbsFile"></span></td>
						</tr>
						<tr>
							<!--
			...
			<div class="sub_content_wrapper">
				<table width="100%" id="publicationsTbl" class="list_tbl mgb_20">
					   <colgroup>
						...
						<tbody>
							<c:if test="${fn:length(jcrList) > 0}">
								<c:forEach items="${jcrList}" var="item" varStatus="status">
