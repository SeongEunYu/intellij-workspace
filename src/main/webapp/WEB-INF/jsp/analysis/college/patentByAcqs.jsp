...
<head>
<title><spring:message code="menu.asrms.clg.patentByAcqs"/></title>
...
function patentByAcqsAjax(idx){
    ...
    $.ajax({
        url:"<c:url value="/analysis/college/patentByAcqsAjax.do"/>",
        dataType: "json",
        data: $('#frm').serialize(),
        method: "POST",
...
<body>
<h3 class="page_title"><spring:message code="menu.asrms.clg.patentByAcqs"/></h3>
<div class="help_text mgb_30"><spring:message code="asrms.college.patentByAcqs.desc"/></div>
