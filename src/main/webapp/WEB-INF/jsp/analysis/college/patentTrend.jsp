...
<head>
<title><spring:message code="menu.asrms.clg.patentTrend"/></title>
...
function patentTrendAjax(){
    ...
    $.ajax({
        url:"<c:url value="/analysis/college/patentTrendAjax.do"/>",
        dataType: "json",
        data: $('#frm').serialize(),
        method: "POST",
...
<body>
<h3 class="page_title"><spring:message code="menu.asrms.clg.patentTrend"/></h3>
<div class="help_text mgb_30"><spring:message code="asrms.college.patentTrend.desc"/></div>
