...
<head>
<title><spring:message code="menu.asrms.clg.artco"/></title>
...
<script type="text/javascript">
 ...
 function departNoArtsAjax(){
     ...
     $.ajax({
         url:"<c:url value="/analysis/college/departNoArtsAjax.do"/>",
         dataType: "json",
         data: $('#frm').serialize(),
         method: "POST",
...
<h3 class="page_title"><spring:message code="menu.asrms.clg.artco"/></h3>
<div class="help_text mgb_30"><spring:message code="asrms.college.publications.comp.desc"/></div>
