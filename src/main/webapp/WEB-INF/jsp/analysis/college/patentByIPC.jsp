...
<head>
<title><spring:message code="menu.asrms.clg.patentByIPC"/></title>
...
function patentByIPCAjax(){
    ...
    $.ajax({
        url:"<c:url value="/analysis/college/patentByIPCAjax.do"/>",
        dataType: "json",
        data: $('#frm').serialize(),
        method: "POST",
...
<body>
<h3 class="page_title"><spring:message code="menu.asrms.clg.patentByIPC"/></h3>
<div class="help_text mgb_30"><spring:message code="asrms.college.patentByIPC.desc"/></div>
