...
<html>
<head>
    <title><spring:message code="menu.asrms.clg.oaJournals"/></title>
    ...
    <script type="text/javascript">
        ...
        function journalAjax(){
            ...
            $.ajax({
                url:"<c:url value="/analysis/college/oaJournalAjax.do"/>",
                dataType: "json",
                data: $('#frm').serialize(),
                method: "POST",
        ...
        function selectRow(issn){
            $.ajax({
                url : "<c:url value="/analysis/college/findJournalInfoByIssnNoAjax.do"/>",
                dataType : 'json',
                data : { "issnNo":issn,
                    "gubun": $('#gubun').val()
                },
        ...
        function clickNoPublications(issn_no){
            ...
            $.ajax({
                url : "${contextPath}/analysis/college/findArticleListByIssnNoAjax.do",
                dataType : 'json',
...
<body>
<h3 class="page_title"><spring:message code="menu.asrms.clg.oaJournals"/></h3>
<div class="help_text mgb_30"><spring:message code="asrms.clg.oaJournals.desc"/></div>
