...
<script type="text/javascript">
 ...
 function fulltimeArticleAjax(){
     $.ajax({
         url:"<c:url value="/analysis/college/fulltimeArticleAjax.do"/>",
         dataType: "json",
         data: $('#frm').serialize(),
         method: "POST",
         ...
         var $tbody = "";
         for(var i=0; i<data.fulltimeArticleSelectedYearList.length; i++){
             var fl = data.fulltimeArticleSelectedYearList[i];
...
<body>
	<h3 class="page_title"><spring:message code="menu.asrms.clg.fulltimeArticle"/></h3>
	<div class="help_text mgb_30"><spring:message code="asrms.college.fulltime.article.desc"/></div>
	<!-- content -->
