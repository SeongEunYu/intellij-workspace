...
<head>
<title><spring:message code="menu.asrms.clg.patentByNation"/></title>
...
function patentByNationAjax(){
    ...
    $.ajax({
        url:"<c:url value="/analysis/college/patentByNationAjax.do"/>",
        dataType: "json",
        data: $('#frm').serialize(),
        method: "POST",
...
<body>
<h3 class="page_title"><spring:message code="menu.asrms.clg.patentByNation"/></h3>
<div class="help_text mgb_30"><spring:message code="asrms.college.patentByNation.desc"/></div>
