...
<head>
<title><spring:message code="menu.asrms.clg.techtrans"/></title>
...
function tcntrnsAjax(idx){
	...
	$.ajax({
		url:"<c:url value="/analysis/college/tcntrnsAjax.do"/>",
		dataType: "json",
		data: $('#frm').serialize(),
		method: "POST",
...
<body>
	<h3 class="page_title"><spring:message code="menu.asrms.clg.techtrans"/></h3>
	<div class="help_text mgb_30"><spring:message code="asrms.college.techtrans.desc"/></div>
