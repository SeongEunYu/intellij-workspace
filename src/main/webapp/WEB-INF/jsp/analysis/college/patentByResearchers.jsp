...
<head>
<title><spring:message code="menu.asrms.clg.patentByResearchers"/></title>
...
<script>
 ...
 function patentByResearchersAjax(idx){
     ...
     $.ajax({
         url:"<c:url value="/analysis/college/patentByResearchersAjax.do"/>",
         dataType: "json",
         data: $('#frm').serialize(),
         method: "POST",
...
<body>
<h3 class="page_title"><spring:message code="menu.asrms.clg.patentByResearchers"/></h3>
<div class="help_text mgb_30"><spring:message code="asrms.college.patentByResearchers.desc"/></div>
