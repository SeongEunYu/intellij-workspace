...
<head>
<title><spring:message code="menu.asrms.clg.fundingByResearchers"/></title>
...
function fundingByResearchersAjax(idx){
    ...
    $.ajax({
        url:"<c:url value="/analysis/college/fundingByResearchersAjax.do"/>",
        dataType: "json",
        data: $('#frm').serialize(),
        method: "POST",
...
<body>
<h3 class="page_title"><spring:message code="menu.asrms.clg.fundingByResearchers"/></h3>
<div class="help_text mgb_30"><spring:message code="asrms.college.fundingByResearchers.desc"/></div>
