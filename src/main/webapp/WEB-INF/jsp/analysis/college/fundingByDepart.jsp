...
<head>
<title><spring:message code="menu.asrms.clg.fundingByDepart"/></title>
...
function fundingByDepartAjax(idx){
    ...
    $.ajax({
        url:"<c:url value="/analysis/college/fundingByDepartAjax.do"/>",
        dataType: "json",
        data: $('#frm').serialize(),
        method: "POST",
...
<body>
<h3 class="page_title"><spring:message code="menu.asrms.clg.fundingByDepart"/></h3>
<div class="help_text mgb_30"><spring:message code="asrms.college.fundingByDepart.desc"/></div>
