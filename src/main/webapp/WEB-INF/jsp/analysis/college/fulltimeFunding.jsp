...
<title><spring:message code="menu.asrms.clg.fulltimeFunding"/></title>
...
function fulltimeFundingAjax(idx){
	...
	$.ajax({
		url:"<c:url value="/analysis/college/fulltimeFundingAjax.do"/>",
		dataType: "json",
		data: $('#frm').serialize(),
		method: "POST",
 ...
 function saveExcel(fileName){
	 ...
	 var excelFileName = "fulltimeFunding_from_" + $('#fromYear').val() +"_to_" + $('#toYear').val() + ".xls";
...
<body>
<h3 class="page_title"><spring:message code="menu.asrms.clg.fulltimeFunding"/></h3>
<div class="help_text mgb_30"><spring:message code="asrms.college.fulltimeFunding.desc"/></div>
