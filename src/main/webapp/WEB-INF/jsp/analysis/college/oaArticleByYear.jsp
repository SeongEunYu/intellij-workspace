...
<html>
<head>
    <title><spring:message code="menu.asrms.clg.oaByYear"/></title>
    ...
    <script type="text/javascript">
        ...
        function oaByYearAjax(idx){
            ...
            $.ajax({
                url:"<c:url value="/analysis/college/oaArticleByYearAjax.do"/>",
                dataType: "json",
                data: $('#frm').serialize(),
                method: "POST",
...
<body>
    <h3 class="page_title"><spring:message code="menu.asrms.clg.oaByYear"/></h3>
    <div class="help_text mgb_30"><spring:message code="asrms.clg.oaByYear.desc"/></div>
