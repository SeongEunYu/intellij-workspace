...
<head>
<title><spring:message code="menu.asrms.inst.patentByTrend"/></title>
...
function patentTrendAjax(){
    ...
    $.ajax({
        url:"<c:url value="/analysis/institution/patentTrendAjax.do"/>",
        dataType: "json",
        data: $('#frm').serialize(),
        method: "POST",
...
<body>
<h3 class="page_title"><spring:message code="menu.asrms.inst.patentTrend"/></h3>
<div class="help_text mgb_30"><spring:message code="asrms.institution.patentTrend.desc"/></div>
