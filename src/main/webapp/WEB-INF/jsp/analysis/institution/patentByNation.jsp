...
<head>
<title><spring:message code="menu.asrms.inst.patentByNation"/></title>
...
function patentByNationAjax(){
    ...
    $.ajax({
        url:"<c:url value="/analysis/institution/patentByNationAjax.do"/>",
        dataType: "json",
        data: $('#frm').serialize(),
        method: "POST",
...
<body>
<h3 class="page_title"><spring:message code="menu.asrms.inst.patentByNation"/></h3>
<div class="help_text mgb_30"><spring:message code="asrms.institution.patentByNation.desc"/></div>
