...
<head>
<title><spring:message code="menu.asrms.inst.fundingByResearchers"/></title>
...
function fundingByResearchersAjax(idx){
    ...
    $.ajax({
        url:"<c:url value="/analysis/institution/fundingByResearchersAjax.do"/>",
        dataType: "json",
        data: $('#frm').serialize(),
        method: "POST",
        ...
        if(data.userList.length > 0){
            ...
            var $tr = '<tr style="background-color: #ffffff;" height="17px"><td style="font-size: 10pt;" align="center" colspan=2><img src="${contextPath}/images/layout/ico_info.png" /> 검색된 결과가 없습니다.</td></tr>';
            $tbody += $tr;
        }
...
<body>
	<h3 class="page_title"><spring:message code="menu.asrms.inst.fundingByResearchers"/></h3>
	<div class="help_text mgb_30"><spring:message code="asrms.institution.fundingByResearchers.desc"/></div>
