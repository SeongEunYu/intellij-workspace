...
<head>
<title><spring:message code="menu.asrms.inst.funding"/></title>
...
function fundingAjax(idx){
    ...
    $.ajax({
        url:"<c:url value="/analysis/institution/fundingAjax.do"/>",
        dataType: "json",
        data: $('#frm').serialize(),
        method: "POST",
...
<body>
<h3 class="page_title"><spring:message code="menu.asrms.inst.funding"/></h3>
<div class="help_text mgb_30"><spring:message code="asrms.institution.funding.desc"/></div>
