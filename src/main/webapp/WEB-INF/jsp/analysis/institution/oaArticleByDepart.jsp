...
<html>
<head>
    <title><spring:message code="menu.asrms.inst.oaByDepart"/></title>
    ...
    <script type="text/javascript">
        ...
        function oaByDepartAjax(idx){
            ...
            $.ajax({
                url:"<c:url value="/analysis/institution/oaArticleByDepartAjax.do"/>",
                dataType: "json",
                data: $('#frm').serialize(),
                method: "POST",
...
<body>
    <h3 class="page_title"><spring:message code="menu.asrms.inst.oaByDepart"/></h3>
    <div class="help_text mgb_30"><spring:message code="asrms.institution.oaByDepart.desc"/></div>
