...
<html>
<head>
    <title><spring:message code="menu.asrms.inst.oaJournals"/></title>
    <link rel=stylesheet type=text/css	href="<c:url value="/css/jquery/fixedheader.css"/>">
    <script type="text/javascript" src="<c:url value="/js/jquery/jquery.fixedheadertable.min.js"/>"></script>
    <style>.select_row {background: #fee79a !important;}</style>
    ...
    <script type="text/javascript">
        ...
        function journalAjax(){
            ...
            $.ajax({
                url:"<c:url value="/analysis/institution/oaJournalAjax.do"/>",
                dataType: "json",
                data: $('#frm').serialize(),
                method: "POST",
        ...
        function selectRow(issn){
            $.ajax({
                url : "<c:url value="/analysis/institution/findJournalInfoByIssnNoAjax.do"/>",
                dataType : 'json',
                data : { "issnNo":issn,
                    "gubun": $('#gubun').val()
                },
        ...
        function saveExcel(fileName){
            ...
            var excelFileName = " OA_Article_Journal_"+$('#gubun').val() + "_from_" + $('#fromYear').val() +"_to_" + $('#toYear').val() + ".xls";
        ...
        function clickNoPublications(issn_no){
            ...
            $.ajax({
                url : "${contextPath}/analysis/institution/findArticleListByIssnNoAjax.do",
                dataType : 'json',
...
<body>
<h3 class="page_title"><spring:message code="menu.asrms.inst.oaJournals"/></h3>
<div class="help_text mgb_30"><spring:message code="asrms.inst.oaJournals.desc"/></div>
