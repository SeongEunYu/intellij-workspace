...
<head>
<title><spring:message code="menu.asrms.inst.techtrans"/></title>
...
function tcntrnsAjax(idx){
    ...
    $.ajax({
        url:"<c:url value="/analysis/institution/tcntrnsAjax.do"/>",
        dataType: "json",
        data: $('#frm').serialize(),
        method: "POST",
...
<body>
<h3 class="page_title"><spring:message code="menu.asrms.inst.techtrans"/></h3>
<div class="help_text mgb_30"><spring:message code="asrms.institution.techtrans.desc"/></div>
