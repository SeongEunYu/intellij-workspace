...
<html>
<head>
    <title><spring:message code="menu.asrms.inst.oaSubjects"/></title>
    ...
    <script type="text/javascript">
        ...
        function subjectAjax(){
            ...
            $.ajax({
                url:"<c:url value="/analysis/institution/subjectAjax.do"/>",
                dataType: "json",
                data: $('#frm').serialize(),
                method: "POST",
...
<h3><spring:message code="menu.asrms.inst.oaSubjects"/></h3>
<div class="help_text mgb_30"><spring:message code="asrms.inst.oaSubjects.desc"/></div>
