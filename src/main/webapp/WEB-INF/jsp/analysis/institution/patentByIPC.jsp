...
<head>
<title><spring:message code="menu.asrms.inst.patentByIPC"/></title>
...
function patentByIPCAjax(){
    ...
    $.ajax({
        url:"<c:url value="/analysis/institution/patentByIPCAjax.do"/>",
        dataType: "json",
        data: $('#frm').serialize(),
        method: "POST",
...
function printDataTable(){
    ...
    if(djArr.length == 0){
        tbody.append('<tr><td colspan="99" style="padding-left:5px;"><img src="${contextPath}/images/layout/ico_info.png" /> 검색된 Data가 없습니다.</td></tr>');
    }
...
<body>
<h3 class="page_title"><spring:message code="menu.asrms.inst.patentByIPC"/></h3>
<div class="help_text mgb_30"><spring:message code="asrms.institution.patentByIPC.desc"/></div>
...
<form id="frm" name="frm">
	...
	<div class="top_option_box">
		...
		<p class="ts_bt_box">
			<a href="javascript:patentByIPCAjax();" class="to_search_bt"><span>Search</span></a>
		</p>
	</div>
