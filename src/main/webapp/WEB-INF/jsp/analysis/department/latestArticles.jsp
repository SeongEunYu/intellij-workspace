...
<head>
<title><spring:message code="menu.asrms.dept.latest"/></title>
...
function latestArticlesAjax(){
    $.ajax({
        url:"<c:url value="/analysis/department/latestArticlesAjax.do"/>",
        dataType: "json",
        data: $('#frm').serialize(),
        method: "POST",
...
function exportExcel(){
	 ...
	 var docTitle = $('<tr><td style="text-align:center;"><h1><p>Department(${item.deptKor}) - '+$('.page_title').html()+'</p></h1></td></tr>');
	 ...
	 var excelFileName = "DepartmentLatestArticles_"+$('#gubun').val() + ".xls";
...
<body>
	<h3 class="page_title"><spring:message code="menu.asrms.dept.latest"/></h3>
	<div class="help_text mgb_30"><spring:message code="asrms.department.latest.article.desc"/></div>
