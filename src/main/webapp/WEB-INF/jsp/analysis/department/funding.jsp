...
<head>
<title><spring:message code="menu.asrms.dept.funding"/></title>
...
function fundingAjax(idx){
    ...
    $.ajax({
        url:"<c:url value="/analysis/department/fundingAjax.do"/>",
        dataType: "json",
        data: $('#frm').serialize(),
        method: "POST",
...
<body>
<h3 class="page_title"><spring:message code="menu.asrms.dept.funding"/></h3>
<div class="help_text mgb_30"><spring:message code="asrms.department.funding.desc"/></div>
