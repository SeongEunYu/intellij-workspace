...
.black_bt .data_update { background:url("<c:url value="/images/background/list_icon_set.png"/>")  no-repeat -2px -949px; }
@media print {
...
var prevFromYear = "";
var prevToYear = "";
var resFlag1,resFlag2,resFlag3,resFlag4,resFlag5,resFlag6,resFlagKey = false;
    ...
    $("#tabs").tabs({
        activate: function( event, ui ) {
            if(ui.newPanel.is('#tabs-1')){
                tabOnOff("tab1");
                subTab("tab1","chart");
                $("#stndYearArea").css('display', '');
                $("#stndMonthDayArea").css('display', '');
...
function search() {
    ...
    if(initNum != 1 && (!resFlag1 || !resFlag2 || !resFlag3 || !resFlag4 || !resFlag5 || !resFlag6 || !resFlagKey)){
    ...
    resFlag1,resFlag2,resFlag3,resFlag4,resFlag5,resFlag6,resFlagKey = false;
...
function pdfWork(){
    ...
    console.log($(".asrims_contents").html());
...
<div class="help_text mgb_15"><spring:message code="asrms.institution.onePageReport.desc"/><br/>데이터 추출일: <c:out value="${fn:substring(pnttmDate,0,4)}.${fn:substring(pnttmDate,4,6)}.${fn:substring(pnttmDate,6,8)}"/></div>
...
<div id="tabs" style="margin-bottom: 0px;">
        ...
        <ul>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li><a href='javascript:subTab("tab3","rsch")' class="sub_menuC" id="tab3ByRsch">By Professor</a></li>
                </ul>
            </li>
        </ul>
    </div>
    <div class="top_option_box">
        <form id="selectForm">
            <input type="hidden" name="deptKor" value="${item.deptKor}">
            <div class="to_inner">
                <c:set var="now" value="<%=new java.util.Date()%>" />
                <c:set var="sysYear"><fmt:formatDate value="${now}" pattern="yyyy" /></c:set>
                <div style="margin-bottom: 5px;" id="langArea">
                        ...
                        <em>
                            <select name="stndYear" id="stndYear">
                                <c:forEach var="year" begin="${sysYear - 9}" end="${sysYear}">
                                    <option value="${sysYear - year + sysYear - 9}" ${(sysYear-1) == (sysYear - year + sysYear - 9) ? 'selected="selected"' : ''}><c:out value="${sysYear - year + sysYear - 9}"/></option>
                                </c:forEach>
                            </select>
                        </em>
                    </span>
                ...
                <em>
                    <select name="fromYear" id="fromYear">
                        <c:forEach var="year" begin="${sysYear - 9}" end="${sysYear}">
                            <option value="${sysYear - year + sysYear - 9}" ${(sysYear-3) == (sysYear - year + sysYear - 9) ? 'selected="selected"' : ''}><c:out value="${sysYear - year + sysYear - 9}"/></option>
                        </c:forEach>
                    </select>
                </em>
                ~
    ...
    <div class="asrims_contents" style="margin-bottom: 0px;">
                    ...
                    <div class="op_title_box">
                        <div class="op_title">
                            <img src="<c:url value="/images/analysis/background/onepage_title01.png"/>" width="436px"
                                 height="auto"/>
                            <span class="op_title_dept koTag"><c:out value="${item.deptKor}"/></span>
                            <span class="op_title_dept enTag"><c:out value="${item.deptEngNm}"/></span>
                        </div>
                        ...
                        <div class="row_box">
                            ...
                            <table class="one_tbl" id="artOverTb">
                                ...
                                <tr>
                                    ...
                                    <th style="border-right: 1px solid white;" class="enTag">Avg. No. of Papers<br/>per Prof.</th>
                        ...
                        <div class="row_box">
                            ...
                            <table class="one_tbl one_tbl" id="fundTb">
                                ...
                                <tr>
                                    ...
                                    <th class="enTag" style="border-right: 1px solid white;">No. of Research Project<br/>per Prof.</th>
                ...
                <div class="onepage_inner" style="margin-bottom: 10px; margin-bottom: 10px;">
                    ...
                    <div class="top_summary_wrap">
                        <div class="top_summary_row">
                            ...
                            <div class="summary_box">
                                <div class="sb_inner">
                                    <span><img src="<c:url value="/images/background/onepage_icon05.png"/>" width="44px"height="auto" alt="Research Fundings" /></span>
                                    <div class="sb_num">
                                        <dl>
                            ...
                            <div class="summary_box">
                                <div class="sb_inner">
                                    <span><img src="<c:url value="/images/background/onepage_icon06.png"/>" width="44px"height="auto" alt="Patents"/></span>
                                    <div class="sb_num">
                                        <dl>
                            ...
                            <div class="summary_box">
                                <div class="sb_inner">
                                    <span><img src="<c:url value="/images/background/onepage_icon07.png"/>" width="44px"height="auto" alt="Conference" /></span>
                                    <div class="sb_num">
                                        <dl>
                    ...
                    <div class="one_con_wrap">
                        ...
                        <div id="networkDiv" style="padding-top: 20px;height: 450px;">
                            <h4 class="onepage_title enTag">Department Collaboration Network</h4>
                            <h4 class="onepage_title koTag">학과연계 네트워크</h4>
            ...
            <div id="div_sciData" class="onepage_wrap">
                ...
                <div class="onepage_inner" style="margin-bottom: 10px; margin-bottom: 10px;">
                    <div class="op_title_box">
                        ...
                        <div class="year_rbox"><span class='enTag' style="color: #777;font-weight:normal;">Year Range</span><span class='koTag' style="color: #777;font-weight:normal;">성과기간</span> <span class="yearRange"></span></div>
                    </div>
                    <div class="top_summary_wrap">
                        <div class="top_summary_row">
                            <div class="summary_box">
                    ...
                    <div class="one_con_wrap" style="margin-top: 40px;">
                        <div class="row_box">
                            ...
                            <table class="one_tbl" id="sciAnalyTb">
                                ...
                                <tr>
                                    ...
                                    <th style="border-right: 1px solid white;" class="koTag">논문당 평균<br/>피인용수</th>
                                    <th style="border-right: 1px solid white;" class="enTag">Avg. No. of Citations<br/>per Paper</th>
                                    <th style="border-right: 1px solid white;" class="koTag">교원1인당<br/>평균 논문수</th>
                                    <th style="border-right: 1px solid white;" class="enTag">Avg. No. of Papers<br/>per Prof.</th>
                                    <th style="border-right: 1px solid white;" class="koTag">교원1인당<br/>평균 IF 합계</th>
                                    <th style="border-right: 1px solid white;" class="enTag">Total of Avg. No. of IF<br/>per Prof.</th>
                                    <th style="border-right: 1px solid white;" class="koTag">교원1인의<br/>논문 1편당 평균 IF</th>
                                    <th style="border-right: 1px solid white;" class="enTag">Avg. No. of IF per Paper<br/>of a prof.</th>
                        ...
                        <div class="row_box">
                            ...
                            <h4 class="onepage_title mgb_0 enTag">Detailed Summary of SCI Papers by Researcher</h4>
                        ...
                        <div class="row_box">
                            ...
                            <h4 class="onepage_title mgb_0 enTag">Analysis of SCI Papers by IF Category(within the top 10%)</h4>
                            <table class="one_tbl" id="sciAnalyTb2">
                                ...
                                <tr>
                                    ...
                                    <th style="border-right: 1px solid white;" class="enTag">No. of the top 10% papers</th>
                                    <th style="border-right: 1px solid white;" class="koTag">IF 10% 논문비율<br/>by 주제별</th>
                                    <th style="border-right: 1px solid white;" class="enTag">Ratio of the top 10% papers</th>
                        ...
                        <div class="row_box">
                            ...
                            <h4 class="onepage_title mgb_0 enTag">Analysis of SCI Papers by IF Category(within the top 20%)</h4>
                            <table class="one_tbl" id="sciAnalyTb3">
                                ...
                                <tr>
                                    ...
                                    <th style="border-right: 1px solid white;" class="enTag">No. of the top 20% papers</th>
                                    <th style="border-right: 1px solid white;" class="koTag">IF 20% 논문비율<br/>by 주제별</th>
                                    <th style="border-right: 1px solid white;" class="enTag">Ratio of the top 20% papers</th>
                        ...
                        <div class="row_box">
                            ...
                            <table class="one_tbl" id="sciTcAnalyTb">
                                ...
                                <tr>
                                    ...
                                    <th style="border-right: 1px solid white;" class="enTag">No. of Citation Papers<br/>within the top 1%</th>
                                    ...
                                    <th style="border-right: 1px solid white;" class="enTag">Ratio of Citation Papers</th>
                        ...
                        <div class="row_box">
                            ...
                            <table class="one_tbl" id="journalTb">
                                ...
                                <tr>
                                    ...
                                    <th style="width: 70px;border-right: 1px solid white;" class="enTag">Total No. of Papers</th>
                        ...
                        <div class="row_box">
                            <h4 class="onepage_title mgb_0 enTag">Department Collaboration Network</h4>
                            <h4 class="onepage_title mgb_0 koTag">학과연계 네트워크</h4>
            ...
            <div id="div_jnlArt" class="onepage_wrap">
                ...
                <div class="onepage_inner" style="margin-bottom: 10px; margin-bottom: 10px;">
                    <div class="op_title_box">
                        ...
                        <div class="year_rbox"><span style="color: #777;font-weight:normal;">Year Range</span> <span class="yearRange"></span></div>
                    </div>
                    <div class="one_con_wrap">
                        <div class="row_box" style="margin-top: 5px;">
                            ...
                            <table class="one_tbl" id="abstArtTb">
                                ...
                                <tr>
                                    ...
                                    <th colspan="3" style="width: 50px;border-right: 1px solid white;border-bottom: 1px solid white;">국제논문</th>
                                    <th colspan="3" style="border-right: 1px solid white;border-bottom: 1px solid white;">국내논문</th>
                                    <th rowspan="2" style="border-right: 1px solid white;">총계</th>
                                    <th colspan="4" style="border-right: 1px solid white;border-bottom: 1px solid white;">SCI/SSCI</th>
                        ...
                        <div class="row_box">
                            ...
                            <table class="one_tbl" id="abstSciConTb">
                                ...
                                <tr>
                                    ...
                                    <th colspan="2" style="border-right: 1px solid white;border-bottom: 1px solid white;">SCI급</th>
                        ...
                        <div class="row_box">
                            ...
                            <table class="one_tbl" id="abstConTb">
                                ...
                                <tr>
                                    <th rowspan="2" style="width: 70px;border-right: 1px solid white;">연도</th>
                                    <th rowspan="2" style="border-right: 1px solid white;">총계</th>
                                    <th colspan="2" style="border-right: 1px solid white;border-bottom: 1px solid white;">국제논문</th>
                                    <th colspan="2" style="border-right: 1px solid white;border-bottom: 1px solid white;">국내논문</th>
                                    <th rowspan="2">전임재직교원수</th>
                                </tr>
                                <tr>
        ...
        <div class="onepage_footer">
            <p style="font-size: 11px;letter-spacing:-0.5px">이 Report는 RIMS 데이터를 기반으로 작성되었습니다. 각 성과별 수치는 참조용이며 연구과제, 특허는 현재기준 ERP 데이터와 다를 수 있습니다.</p>
