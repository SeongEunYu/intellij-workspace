...
<head>
	<title><spring:message code="menu.asrms.dept.fundingByDvs"/></title>
...
function fundingByDvsAjax(idx){
    ...
    $.ajax({
        url:"<c:url value="/analysis/department/fundingByDvsAjax.do"/>",
        dataType: "json",
        data: $('#frm').serialize(),
        method: "POST",
...
<body>
<h3 class="page_title"><spring:message code="menu.asrms.dept.fundingByDvs"/></h3>
<div class="help_text mgb_30"><spring:message code="asrms.department.fundingByDvs.desc"/></div>
