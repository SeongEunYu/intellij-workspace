...
<head>
<title><spring:message code="menu.asrms.dept.fundingByGov"/></title>
...
th.header {
 ...
 function fundingByGovAjax(idx){
     ...
     $.ajax({
         url:"<c:url value="/analysis/department/fundingByGovAjax.do"/>",
         dataType: "json",
         data: $('#frm').serialize(),
         method: "POST",
...
<body>
<h3 class="page_title"><spring:message code="menu.asrms.dept.fundingByGov"/></h3>
<div class="help_text mgb_30"><spring:message code="asrms.department.fundingByGov.desc"/></div>
