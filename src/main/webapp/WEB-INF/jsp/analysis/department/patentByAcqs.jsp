...
<head>
	<title><spring:message code="menu.asrms.dept.patentByAcqs"/></title>
...
function patentByAcqsAjax(idx){
    ...
    $.ajax({
        url:"<c:url value="/analysis/department/patentByAcqsAjax.do"/>",
        dataType: "json",
        data: $('#frm').serialize(),
        method: "POST",
...
<body>
<h3 class="page_title"><spring:message code="menu.asrms.dept.patentByAcqs"/></h3>
<div class="help_text mgb_30"><spring:message code="asrms.department.patentByAcqs.desc"/></div>
